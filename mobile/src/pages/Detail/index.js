...
import * as MailComposer from 'expo-mail-composer'; //enviar email 
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.detailtButton} onPress={navigateToIncidents}>
                    <Text style={styles.detailtButtonText}></Text>
